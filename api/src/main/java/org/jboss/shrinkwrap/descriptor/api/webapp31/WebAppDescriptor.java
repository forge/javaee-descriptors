         ...
         WebAppCommonDescriptor<WebAppDescriptor, ParamValueType<WebAppDescriptor>, ServletType<WebAppDescriptor>, ServletMappingType<WebAppDescriptor>, ErrorPageType<WebAppDescriptor>>
{
   ...
   /**
    * If not already created, a new <code>jms-connection-factory</code> element will be created and returned. Otherwise,
    * the first existing <code>jms-connection-factory</code> element will be returned.
    * 
   ...
   /**
    * If not already created, a new <code>jms-destination</code> element will be created and returned. Otherwise, the
    * first existing <code>jms-destination</code> element will be returned.
    * 
   ...
   /**
    * If not already created, a new <code>mail-session</code> element will be created and returned. Otherwise, the first
    * existing <code>mail-session</code> element will be returned.
    * 
   ...
   /**
    * If not already created, a new <code>connection-factory</code> element will be created and returned. Otherwise, the
    * first existing <code>connection-factory</code> element will be returned.
    * 
   ...
   /**
    * If not already created, a new <code>administered-object</code> element will be created and returned. Otherwise,
    * the first existing <code>administered-object</code> element will be returned.
    * 
