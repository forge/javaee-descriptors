...
/**
 * This interface defines the contract for the <code> faces-config-lifecycle-extensionType </code> xsd type 
 * @author <a href="mailto:ralf.battenfeld@bluewin.ch">Ralf Battenfeld</a>
 * @author <a href="mailto:alr@jboss.org">Andrew Lee Rubinger</a>
 */
public interface FacesConfigLifecycleExtensionType<T> extends Child<T>
{
