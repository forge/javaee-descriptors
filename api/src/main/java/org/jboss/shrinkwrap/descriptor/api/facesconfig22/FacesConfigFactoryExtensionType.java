...
/**
 * This interface defines the contract for the <code> faces-config-factory-extensionType </code> xsd type 
 * @author <a href="mailto:ralf.battenfeld@bluewin.ch">Ralf Battenfeld</a>
 * @author <a href="mailto:alr@jboss.org">Andrew Lee Rubinger</a>
 */
public interface FacesConfigFactoryExtensionType<T> extends Child<T>
{
