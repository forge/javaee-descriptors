...
public interface SecurityConstraintType<T> extends Child<T>,
         SecurityConstraintCommonType<T, SecurityConstraintType<T>, WebResourceCollectionType<SecurityConstraintType<T>>, AuthConstraintType<SecurityConstraintType<T>>, UserDataConstraintType<SecurityConstraintType<T>>>
{
