...
public List<String> getAllDisplayName()
   ...
   // --------------------------------------------------------------------------------------------------------||
   // ClassName: FaceletTaglibType ElementName: xsd:token ElementType : short-name
    ...
    * @return the current instance of <code>FaceletTaglibType<T></code> 
    */
   public FaceletTaglibType<T> shortName(String shortName)
   {
    ...
    * @return the current instance of <code>FaceletTaglibType<T></code> 
    */
   public FaceletTaglibType<T> removeShortName()
   {
