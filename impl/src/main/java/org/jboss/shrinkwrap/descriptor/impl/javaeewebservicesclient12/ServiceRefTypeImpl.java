...
public List<String> getAllDisplayName()
   ...
   // --------------------------------------------------------------------------------------------------------||
   // ClassName: ServiceRefType ElementName: javaee:service-ref_handlerType ElementType : handler
   // MaxOccurs: -unbounded  isGeneric: true   isAttribute: false isEnum: false isDataType: false
   // --------------------------------------------------------------------------------------------------------||
   ...
   // --------------------------------------------------------------------------------------------------------||
   // ClassName: ServiceRefType ElementName: javaee:service-ref_handler-chainsType ElementType : handler-chains
    ...
    * @return  a new or existing instance of <code>ServiceRefHandlerChainsType<ServiceRefType<T>></code> 
    */
   public ServiceRefHandlerChainsType<ServiceRefType<T>> getOrCreateHandlerChains()
   {
      Node node = childNode.getOrCreate("handler-chains");
      ServiceRefHandlerChainsType<ServiceRefType<T>> handlerChains = new ServiceRefHandlerChainsTypeImpl<ServiceRefType<T>>(this, "handler-chains", childNode, node);
