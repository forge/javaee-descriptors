...
public class PersistenceDescriptorImpl extends NodeDescriptorImplBase implements DescriptorNamespace<PersistenceDescriptor>, PersistenceDescriptor
{
   ...
   public PersistenceDescriptor addDefaultNamespaces()
   {
      ...
      addNamespace("xsi:schemaLocation", "http://xmlns.jcp.org/xml/ns/persistence http://xmlns.jcp.org/xml/ns/persistence/persistence_2_1.xsd");
      addNamespace("xmlns", "http://xmlns.jcp.org/xml/ns/persistence");
     return this;
   }
