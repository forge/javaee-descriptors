...
import org.jboss.shrinkwrap.descriptor.impl.orm21.CascadeTypeImpl;
...
public class ManyToManyImpl<T> implements Child<T>, ManyToMany<T>
{
   ...
   // --------------------------------------------------------------------------------------------------------||
   // ClassName: ManyToMany ElementName: orm:convert ElementType : map-key-convert
   // MaxOccurs: -unbounded  isGeneric: true   isAttribute: false isEnum: false isDataType: false
   // --------------------------------------------------------------------------------------------------------||
    ...
    */
   public Convert<ManyToMany<T>> getOrCreateMapKeyConvert()
   {
      List<Node> nodeList = childNode.get("map-key-convert");
      if (nodeList != null &&  nodeList.size() > 0)
      {
         return new ConvertImpl<ManyToMany<T>>(this, "map-key-convert", childNode, nodeList.get(0));
      }
    ...
    * @return the new created instance of <code>Convert<ManyToMany<T>></code> 
    */
   public Convert<ManyToMany<T>> createMapKeyConvert()
   {
      return new ConvertImpl<ManyToMany<T>>(this, "map-key-convert", childNode);
   }
    ...
    */
   public List<Convert<ManyToMany<T>>> getAllMapKeyConvert()
   {
      List<Convert<ManyToMany<T>>> list = new ArrayList<Convert<ManyToMany<T>>>();
      List<Node> nodeList = childNode.get("map-key-convert");
      for(Node node: nodeList)
      {
         Convert<ManyToMany<T>>  type = new ConvertImpl<ManyToMany<T>>(this, "map-key-convert", childNode, node);
         list.add(type);
      }
      return list;
   }
    ...
    * @return the current instance of <code>Convert<ManyToMany<T>></code> 
    */
   public ManyToMany<T> removeAllMapKeyConvert()
   {
   ...
   // --------------------------------------------------------------------------------------------------------||
   // ClassName: ManyToMany ElementName: orm:foreign-key ElementType : map-key-foreign-key
   // MaxOccurs: -  isGeneric: true   isAttribute: false isEnum: false isDataType: false
   // --------------------------------------------------------------------------------------------------------||
    ...
    * @return  a new or existing instance of <code>ForeignKey<ManyToMany<T>></code> 
    */
   public ForeignKey<ManyToMany<T>> getOrCreateMapKeyForeignKey()
   {
      Node node = childNode.getOrCreate("map-key-foreign-key");
      ForeignKey<ManyToMany<T>> mapKeyForeignKey = new ForeignKeyImpl<ManyToMany<T>>(this, "map-key-foreign-key", childNode, node);
    ...
    * @return the current instance of <code>ManyToMany<T></code> 
    */
   public ManyToMany<T> removeMapKeyForeignKey()
   {
