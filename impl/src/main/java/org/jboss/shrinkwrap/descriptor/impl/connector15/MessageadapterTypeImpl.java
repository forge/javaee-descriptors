...
import org.jboss.shrinkwrap.descriptor.impl.connector15.MessagelistenerTypeImpl;
...
public class MessageadapterTypeImpl<T> implements Child<T>, MessageadapterType<T>
{
   ...
   // --------------------------------------------------------------------------------------------------------||
   // ClassName: MessageadapterType ElementName: j2ee:messagelistenerType ElementType : messagelistener
