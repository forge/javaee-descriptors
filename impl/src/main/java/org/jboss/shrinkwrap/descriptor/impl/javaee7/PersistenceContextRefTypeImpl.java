...
import org.jboss.shrinkwrap.descriptor.api.javaee7.PersistenceContextTypeType;
import org.jboss.shrinkwrap.descriptor.api.javaee7.PersistenceContextSynchronizationType;
...
import org.jboss.shrinkwrap.descriptor.impl.javaee7.InjectionTargetTypeImpl;
...
public List<String> getAllDescription()
   ...
   // --------------------------------------------------------------------------------------------------------||
   // ClassName: PersistenceContextRefType ElementName: javaee:persistence-context-synchronizationType ElementType : persistence-context-synchronization
   // MaxOccurs: -  isGeneric: true   isAttribute: false isEnum: true isDataType: false
   // --------------------------------------------------------------------------------------------------------||
   /**
    * Sets the <code>persistence-context-synchronization</code> element
    * @param persistenceContextSynchronization the value for the element <code>persistence-context-synchronization</code> 
    * @return the current instance of <code>PersistenceContextRefType<T></code> 
    */
   public PersistenceContextRefType<T> persistenceContextSynchronization(PersistenceContextSynchronizationType persistenceContextSynchronization)
   {
      childNode.getOrCreate("persistence-context-synchronization").text(persistenceContextSynchronization);
      return this;
   }
   /**
    * Sets the <code>persistence-context-synchronization</code> element
    ...
    * @return the current instance of <code>PersistenceContextRefType<T></code> 
    */
   public PersistenceContextRefType<T> persistenceContextSynchronization(String persistenceContextSynchronization)
   {
      childNode.getOrCreate("persistence-context-synchronization").text(persistenceContextSynchronization);
      return this;
   }
   ...
   /**
    * Returns the <code>persistence-context-synchronization</code> element
    * @return the value found for the element <code>persistence-context-synchronization</code> 
    */
   public PersistenceContextSynchronizationType getPersistenceContextSynchronization()
   {
      return PersistenceContextSynchronizationType.getFromStringValue(childNode.getTextValueForPatternName("persistence-context-synchronization"));
   }
    ...
    * @return the value found for the element <code>persistence-context-synchronization</code> 
    */
   public String  getPersistenceContextSynchronizationAsString()
   {
      return childNode.getTextValueForPatternName("persistence-context-synchronization");
   }

   /**
    * Removes the <code>persistence-context-synchronization</code> attribute 
    * @return the current instance of <code>PersistenceContextRefType<T></code> 
    */
   public PersistenceContextRefType<T> removePersistenceContextSynchronization()
   {
      childNode.removeAttribute("persistence-context-synchronization");
      return this;
   }
