...
import org.jboss.shrinkwrap.descriptor.impl.webapp31.AbsoluteOrderingTypeImpl;
import org.jboss.shrinkwrap.descriptor.api.javaee7.EmptyType;
import org.jboss.shrinkwrap.descriptor.impl.javaee7.EmptyTypeImpl;
...
public class WebAppDescriptorImpl extends NodeDescriptorImplBase implements DescriptorNamespace<WebAppDescriptor>, WebAppDescriptor
{
   ...
   public WebAppDescriptor addDefaultNamespaces()
   {
      ...
      addNamespace("xsi:schemaLocation", "http://xmlns.jcp.org/xml/ns/javaee http://xmlns.jcp.org/xml/ns/javaee/web-app_3_1.xsd");
   ...
   public WebAppDescriptor moduleName(String ... values)
   {
      if (values != null)
      {
         ...
         {
            model.createChild("module-name").text(name);
         }
      }
      return this;
   }
...
public List<String> getAllModuleName()
   ...
   // --------------------------------------------------------------------------------------------------------||
   // ClassName: WebAppDescriptor ElementName: javaee:emptyType ElementType : deny-uncovered-http-methods
   // MaxOccurs: -unbounded  isGeneric: false   isAttribute: false isEnum: false isDataType: true
   // --------------------------------------------------------------------------------------------------------||
    ...
    * @return the current instance of <code>WebAppDescriptor</code> 
    */
   public WebAppDescriptor denyUncoveredHttpMethods()
   {
      model.getOrCreate("deny-uncovered-http-methods");
      return this;
   }
   ...
   {
      return model.getSingle("deny-uncovered-http-methods") != null;
   }
    ...
    * @return the current instance of <code>WebAppDescriptor</code> 
    */
   public WebAppDescriptor removeDenyUncoveredHttpMethods()
   {
      model.removeChild("deny-uncovered-http-methods");
      return this;
   }
   ...
   public AbsoluteOrderingType<WebAppDescriptor> getOrCreateAbsoluteOrdering()
   {
      ...
      {
         return new AbsoluteOrderingTypeImpl<WebAppDescriptor>(this, "absolute-ordering", model, nodeList.get(0));
      }
   ...
   {
      return new AbsoluteOrderingTypeImpl<WebAppDescriptor>(this, "absolute-ordering", model);
   }
   ...
   {
      List<AbsoluteOrderingType<WebAppDescriptor>> list = new ArrayList<AbsoluteOrderingType<WebAppDescriptor>>();
      List<Node> nodeList = model.get("absolute-ordering");
      for(Node node: nodeList)
      {
         AbsoluteOrderingType<WebAppDescriptor>  type = new AbsoluteOrderingTypeImpl<WebAppDescriptor>(this, "absolute-ordering", model, node);
         list.add(type);
      }
      return list;
   }
...
public List<String> getAllDisplayName()
   ...
   public DataSourceType<WebAppDescriptor> getOrCreateDataSource()
   {
      ...
      if (nodeList != null &&  nodeList.size() > 0)
      {
         return new DataSourceTypeImpl<WebAppDescriptor>(this, "data-source", model, nodeList.get(0));
      }
   ...
   {
      return new DataSourceTypeImpl<WebAppDescriptor>(this, "data-source", model);
   }
   ...
   {
      List<DataSourceType<WebAppDescriptor>> list = new ArrayList<DataSourceType<WebAppDescriptor>>();
      List<Node> nodeList = model.get("data-source");
      for(Node node: nodeList)
      {
         DataSourceType<WebAppDescriptor>  type = new DataSourceTypeImpl<WebAppDescriptor>(this, "data-source", model, node);
         list.add(type);
      }
      return list;
   }
   ...
   // --------------------------------------------------------------------------------------------------------||
   // ClassName: WebAppDescriptor ElementName: javaee:jms-connection-factoryType ElementType : jms-connection-factory
   // MaxOccurs: -unbounded  isGeneric: false   isAttribute: false isEnum: false isDataType: false
   // --------------------------------------------------------------------------------------------------------||
    ...
    */
   public JmsConnectionFactoryType<WebAppDescriptor> getOrCreateJmsConnectionFactory()
   {
      List<Node> nodeList = model.get("jms-connection-factory");
      if (nodeList != null &&  nodeList.size() > 0)
      {
         return new JmsConnectionFactoryTypeImpl<WebAppDescriptor>(this, "jms-connection-factory", model, nodeList.get(0));
      }
    ...
    * @return the current instance of <code>JmsConnectionFactoryType<WebAppDescriptor></code> 
    */
   public WebAppDescriptor removeAllJmsConnectionFactory()
   {
   ...
   // --------------------------------------------------------------------------------------------------------||
   // ClassName: WebAppDescriptor ElementName: javaee:jms-destinationType ElementType : jms-destination
   // MaxOccurs: -unbounded  isGeneric: false   isAttribute: false isEnum: false isDataType: false
   // --------------------------------------------------------------------------------------------------------||
    ...
    */
   public JmsDestinationType<WebAppDescriptor> getOrCreateJmsDestination()
   {
      List<Node> nodeList = model.get("jms-destination");
      if (nodeList != null &&  nodeList.size() > 0)
      {
         return new JmsDestinationTypeImpl<WebAppDescriptor>(this, "jms-destination", model, nodeList.get(0));
      }
    ...
    * @return the new created instance of <code>JmsDestinationType<WebAppDescriptor></code> 
    */
   public JmsDestinationType<WebAppDescriptor> createJmsDestination()
   {
      return new JmsDestinationTypeImpl<WebAppDescriptor>(this, "jms-destination", model);
   }
   ...
   public List<JmsDestinationType<WebAppDescriptor>> getAllJmsDestination()
   {
      ...
      for(Node node: nodeList)
      {
         JmsDestinationType<WebAppDescriptor>  type = new JmsDestinationTypeImpl<WebAppDescriptor>(this, "jms-destination", model, node);
         list.add(type);
      }
      return list;
   }
    ...
    * @return the current instance of <code>JmsDestinationType<WebAppDescriptor></code> 
    */
   public WebAppDescriptor removeAllJmsDestination()
   {
   ...
   // --------------------------------------------------------------------------------------------------------||
   // ClassName: WebAppDescriptor ElementName: javaee:mail-sessionType ElementType : mail-session
   // MaxOccurs: -unbounded  isGeneric: false   isAttribute: false isEnum: false isDataType: false
   // --------------------------------------------------------------------------------------------------------||
    ...
    */
   public MailSessionType<WebAppDescriptor> getOrCreateMailSession()
   {
      List<Node> nodeList = model.get("mail-session");
      if (nodeList != null &&  nodeList.size() > 0)
      {
         return new MailSessionTypeImpl<WebAppDescriptor>(this, "mail-session", model, nodeList.get(0));
      }
    ...
    * @return the new created instance of <code>MailSessionType<WebAppDescriptor></code> 
    */
   public MailSessionType<WebAppDescriptor> createMailSession()
   {
      return new MailSessionTypeImpl<WebAppDescriptor>(this, "mail-session", model);
   }
    ...
    */
   public List<MailSessionType<WebAppDescriptor>> getAllMailSession()
   {
      List<MailSessionType<WebAppDescriptor>> list = new ArrayList<MailSessionType<WebAppDescriptor>>();
      List<Node> nodeList = model.get("mail-session");
      for(Node node: nodeList)
      {
         MailSessionType<WebAppDescriptor>  type = new MailSessionTypeImpl<WebAppDescriptor>(this, "mail-session", model, node);
         list.add(type);
      }
      return list;
   }
    ...
    * @return the current instance of <code>MailSessionType<WebAppDescriptor></code> 
    */
   public WebAppDescriptor removeAllMailSession()
   {
   ...
   // --------------------------------------------------------------------------------------------------------||
   // ClassName: WebAppDescriptor ElementName: javaee:connection-factory-resourceType ElementType : connection-factory
   // MaxOccurs: -unbounded  isGeneric: false   isAttribute: false isEnum: false isDataType: false
   // --------------------------------------------------------------------------------------------------------||
    ...
    */
   public ConnectionFactoryResourceType<WebAppDescriptor> getOrCreateConnectionFactory()
   {
      List<Node> nodeList = model.get("connection-factory");
      if (nodeList != null &&  nodeList.size() > 0)
      {
         return new ConnectionFactoryResourceTypeImpl<WebAppDescriptor>(this, "connection-factory", model, nodeList.get(0));
      }
    ...
    * @return the new created instance of <code>ConnectionFactoryResourceType<WebAppDescriptor></code> 
    */
   public ConnectionFactoryResourceType<WebAppDescriptor> createConnectionFactory()
   {
      return new ConnectionFactoryResourceTypeImpl<WebAppDescriptor>(this, "connection-factory", model);
   }
    ...
    * @return the current instance of <code>ConnectionFactoryResourceType<WebAppDescriptor></code> 
    */
   public WebAppDescriptor removeAllConnectionFactory()
   {
   ...
   // --------------------------------------------------------------------------------------------------------||
   // ClassName: WebAppDescriptor ElementName: javaee:administered-objectType ElementType : administered-object
   // MaxOccurs: -unbounded  isGeneric: false   isAttribute: false isEnum: false isDataType: false
   // --------------------------------------------------------------------------------------------------------||
    ...
    */
   public AdministeredObjectType<WebAppDescriptor> getOrCreateAdministeredObject()
   {
      List<Node> nodeList = model.get("administered-object");
      if (nodeList != null &&  nodeList.size() > 0)
      {
         return new AdministeredObjectTypeImpl<WebAppDescriptor>(this, "administered-object", model, nodeList.get(0));
      }
    ...
    * @return the new created instance of <code>AdministeredObjectType<WebAppDescriptor></code> 
    */
   public AdministeredObjectType<WebAppDescriptor> createAdministeredObject()
   {
      return new AdministeredObjectTypeImpl<WebAppDescriptor>(this, "administered-object", model);
   }
    ...
    */
   public List<AdministeredObjectType<WebAppDescriptor>> getAllAdministeredObject()
   {
      List<AdministeredObjectType<WebAppDescriptor>> list = new ArrayList<AdministeredObjectType<WebAppDescriptor>>();
      List<Node> nodeList = model.get("administered-object");
      for(Node node: nodeList)
      {
         AdministeredObjectType<WebAppDescriptor>  type = new AdministeredObjectTypeImpl<WebAppDescriptor>(this, "administered-object", model, node);
         list.add(type);
      }
      return list;
   }
    ...
    * @return the current instance of <code>AdministeredObjectType<WebAppDescriptor></code> 
    */
   public WebAppDescriptor removeAllAdministeredObject()
   {
