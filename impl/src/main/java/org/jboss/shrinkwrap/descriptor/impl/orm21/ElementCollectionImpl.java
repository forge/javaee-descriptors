...
public class ElementCollectionImpl<T> implements Child<T>, ElementCollection<T>
{
    ...
    */
   public Convert<ElementCollection<T>> getOrCreateMapKeyConvert()
   {
      List<Node> nodeList = childNode.get("map-key-convert");
      if (nodeList != null &&  nodeList.size() > 0)
      {
         return new ConvertImpl<ElementCollection<T>>(this, "map-key-convert", childNode, nodeList.get(0));
      }
      return createMapKeyConvert();
   }

   /**
    * Creates a new <code>map-key-convert</code> element 
    * @return the new created instance of <code>Convert<ElementCollection<T>></code> 
    */
   public Convert<ElementCollection<T>> createMapKeyConvert()
   {
      return new ConvertImpl<ElementCollection<T>>(this, "map-key-convert", childNode);
   }
    ...
    */
   public List<Convert<ElementCollection<T>>> getAllMapKeyConvert()
   {
      List<Convert<ElementCollection<T>>> list = new ArrayList<Convert<ElementCollection<T>>>();
      List<Node> nodeList = childNode.get("map-key-convert");
      for(Node node: nodeList)
      {
         Convert<ElementCollection<T>>  type = new ConvertImpl<ElementCollection<T>>(this, "map-key-convert", childNode, node);
         list.add(type);
      }
      return list;
   }
    ...
    * @return the current instance of <code>Convert<ElementCollection<T>></code> 
    */
   public ElementCollection<T> removeAllMapKeyConvert()
   {
      childNode.removeChildren("map-key-convert");
      return this;
   }
    ...
    * @return  a new or existing instance of <code>ForeignKey<ElementCollection<T>></code> 
    */
   public ForeignKey<ElementCollection<T>> getOrCreateMapKeyForeignKey()
   {
      Node node = childNode.getOrCreate("map-key-foreign-key");
      ForeignKey<ElementCollection<T>> mapKeyForeignKey = new ForeignKeyImpl<ElementCollection<T>>(this, "map-key-foreign-key", childNode, node);
    ...
    * @return the current instance of <code>ElementCollection<T></code> 
    */
   public ElementCollection<T> removeMapKeyForeignKey()
   {
      childNode.removeChildren("map-key-foreign-key");
      return this;
   }
    ...
    */
   public Convert<ElementCollection<T>> getOrCreateConvert()
   {
      List<Node> nodeList = childNode.get("convert");
      if (nodeList != null &&  nodeList.size() > 0)
      {
         return new ConvertImpl<ElementCollection<T>>(this, "convert", childNode, nodeList.get(0));
      }
    ...
    * @return the new created instance of <code>Convert<ElementCollection<T>></code> 
    */
   public Convert<ElementCollection<T>> createConvert()
   {
      return new ConvertImpl<ElementCollection<T>>(this, "convert", childNode);
   }
    ...
    */
   public List<Convert<ElementCollection<T>>> getAllConvert()
   {
      List<Convert<ElementCollection<T>>> list = new ArrayList<Convert<ElementCollection<T>>>();
      List<Node> nodeList = childNode.get("convert");
      for(Node node: nodeList)
      {
         Convert<ElementCollection<T>>  type = new ConvertImpl<ElementCollection<T>>(this, "convert", childNode, node);
         list.add(type);
      }
      return list;
   }
    ...
    * @return the current instance of <code>Convert<ElementCollection<T>></code> 
    */
   public ElementCollection<T> removeAllConvert()
   {
