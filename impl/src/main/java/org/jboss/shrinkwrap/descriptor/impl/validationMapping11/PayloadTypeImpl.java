...
/**
 * This class implements the <code> payloadType </code> xsd type 
...
public class PayloadTypeImpl<T> implements Child<T>, PayloadType<T>
{
   ...
   public PayloadTypeImpl(T t, String nodeName, Node node)   {
      this.t = t;
      this.childNode = node.createChild(nodeName);
   }

   public PayloadTypeImpl(T t, String nodeName, Node node, Node childNode)   {
      this.t = t;
