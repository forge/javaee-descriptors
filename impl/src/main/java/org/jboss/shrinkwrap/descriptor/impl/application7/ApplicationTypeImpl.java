...
import org.jboss.shrinkwrap.descriptor.api.application7.ApplicationType;
...
import org.jboss.shrinkwrap.descriptor.impl.application7.ModuleTypeImpl;
...
public List<String> getAllDisplayName()
   ...
   public JmsConnectionFactoryType<ApplicationType<T>> getOrCreateJmsConnectionFactory()
   {
      ...
      if (nodeList != null &&  nodeList.size() > 0)
      {
         return new JmsConnectionFactoryTypeImpl<ApplicationType<T>>(this, "jms-connection-factory", childNode, nodeList.get(0));
      }
   ...
   {
      return new JmsConnectionFactoryTypeImpl<ApplicationType<T>>(this, "jms-connection-factory", childNode);
   }
   ...
   {
      List<JmsConnectionFactoryType<ApplicationType<T>>> list = new ArrayList<JmsConnectionFactoryType<ApplicationType<T>>>();
      List<Node> nodeList = childNode.get("jms-connection-factory");
      for(Node node: nodeList)
      {
         JmsConnectionFactoryType<ApplicationType<T>>  type = new JmsConnectionFactoryTypeImpl<ApplicationType<T>>(this, "jms-connection-factory", childNode, node);
         list.add(type);
      }
      return list;
   }
   ...
   public JmsDestinationType<ApplicationType<T>> getOrCreateJmsDestination()
   {
      ...
      if (nodeList != null &&  nodeList.size() > 0)
      {
         return new JmsDestinationTypeImpl<ApplicationType<T>>(this, "jms-destination", childNode, nodeList.get(0));
      }
   ...
   {
      return new JmsDestinationTypeImpl<ApplicationType<T>>(this, "jms-destination", childNode);
   }
   ...
   {
      List<JmsDestinationType<ApplicationType<T>>> list = new ArrayList<JmsDestinationType<ApplicationType<T>>>();
      List<Node> nodeList = childNode.get("jms-destination");
      for(Node node: nodeList)
      {
         JmsDestinationType<ApplicationType<T>>  type = new JmsDestinationTypeImpl<ApplicationType<T>>(this, "jms-destination", childNode, node);
         list.add(type);
      }
      return list;
   }
   ...
   public MailSessionType<ApplicationType<T>> getOrCreateMailSession()
   {
      ...
      if (nodeList != null &&  nodeList.size() > 0)
      {
         return new MailSessionTypeImpl<ApplicationType<T>>(this, "mail-session", childNode, nodeList.get(0));
      }
   ...
   {
      return new MailSessionTypeImpl<ApplicationType<T>>(this, "mail-session", childNode);
   }
   ...
   {
      List<MailSessionType<ApplicationType<T>>> list = new ArrayList<MailSessionType<ApplicationType<T>>>();
      List<Node> nodeList = childNode.get("mail-session");
      for(Node node: nodeList)
      {
         MailSessionType<ApplicationType<T>>  type = new MailSessionTypeImpl<ApplicationType<T>>(this, "mail-session", childNode, node);
         list.add(type);
      }
      return list;
   }
   ...
   public ConnectionFactoryResourceType<ApplicationType<T>> getOrCreateConnectionFactory()
   {
      ...
      if (nodeList != null &&  nodeList.size() > 0)
      {
         return new ConnectionFactoryResourceTypeImpl<ApplicationType<T>>(this, "connection-factory", childNode, nodeList.get(0));
      }
   ...
   {
      return new ConnectionFactoryResourceTypeImpl<ApplicationType<T>>(this, "connection-factory", childNode);
   }
   ...
   {
      List<ConnectionFactoryResourceType<ApplicationType<T>>> list = new ArrayList<ConnectionFactoryResourceType<ApplicationType<T>>>();
      List<Node> nodeList = childNode.get("connection-factory");
      for(Node node: nodeList)
      {
         ConnectionFactoryResourceType<ApplicationType<T>>  type = new ConnectionFactoryResourceTypeImpl<ApplicationType<T>>(this, "connection-factory", childNode, node);
         list.add(type);
      }
      return list;
   }
   ...
   public AdministeredObjectType<ApplicationType<T>> getOrCreateAdministeredObject()
   {
      ...
      if (nodeList != null &&  nodeList.size() > 0)
      {
         return new AdministeredObjectTypeImpl<ApplicationType<T>>(this, "administered-object", childNode, nodeList.get(0));
      }
   ...
   {
      return new AdministeredObjectTypeImpl<ApplicationType<T>>(this, "administered-object", childNode);
   }
   ...
   {
      List<AdministeredObjectType<ApplicationType<T>>> list = new ArrayList<AdministeredObjectType<ApplicationType<T>>>();
      List<Node> nodeList = childNode.get("administered-object");
      for(Node node: nodeList)
      {
         AdministeredObjectType<ApplicationType<T>>  type = new AdministeredObjectTypeImpl<ApplicationType<T>>(this, "administered-object", childNode, node);
         list.add(type);
      }
      return list;
   }
