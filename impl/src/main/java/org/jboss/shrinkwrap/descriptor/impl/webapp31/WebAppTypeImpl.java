...
import org.jboss.shrinkwrap.descriptor.api.webapp31.WebAppType;
...
public List<String> getAllDisplayName()
   ...
   public JmsConnectionFactoryType<WebAppType<T>> getOrCreateJmsConnectionFactory()
   {
      ...
      if (nodeList != null &&  nodeList.size() > 0)
      {
         return new JmsConnectionFactoryTypeImpl<WebAppType<T>>(this, "jms-connection-factory", childNode, nodeList.get(0));
      }
   ...
   {
      return new JmsConnectionFactoryTypeImpl<WebAppType<T>>(this, "jms-connection-factory", childNode);
   }
   ...
   {
      List<JmsConnectionFactoryType<WebAppType<T>>> list = new ArrayList<JmsConnectionFactoryType<WebAppType<T>>>();
      List<Node> nodeList = childNode.get("jms-connection-factory");
      for(Node node: nodeList)
      {
         JmsConnectionFactoryType<WebAppType<T>>  type = new JmsConnectionFactoryTypeImpl<WebAppType<T>>(this, "jms-connection-factory", childNode, node);
         list.add(type);
      }
      return list;
   }
   ...
   public JmsDestinationType<WebAppType<T>> getOrCreateJmsDestination()
   {
      ...
      if (nodeList != null &&  nodeList.size() > 0)
      {
         return new JmsDestinationTypeImpl<WebAppType<T>>(this, "jms-destination", childNode, nodeList.get(0));
      }
   ...
   {
      return new JmsDestinationTypeImpl<WebAppType<T>>(this, "jms-destination", childNode);
   }
   ...
   {
      List<JmsDestinationType<WebAppType<T>>> list = new ArrayList<JmsDestinationType<WebAppType<T>>>();
      List<Node> nodeList = childNode.get("jms-destination");
      for(Node node: nodeList)
      {
         JmsDestinationType<WebAppType<T>>  type = new JmsDestinationTypeImpl<WebAppType<T>>(this, "jms-destination", childNode, node);
         list.add(type);
      }
      return list;
   }
   ...
   {
      return new MailSessionTypeImpl<WebAppType<T>>(this, "mail-session", childNode);
   }
   ...
   {
      List<MailSessionType<WebAppType<T>>> list = new ArrayList<MailSessionType<WebAppType<T>>>();
      List<Node> nodeList = childNode.get("mail-session");
      for(Node node: nodeList)
      {
         MailSessionType<WebAppType<T>>  type = new MailSessionTypeImpl<WebAppType<T>>(this, "mail-session", childNode, node);
         list.add(type);
      }
      return list;
   }
   ...
   {
      return new ConnectionFactoryResourceTypeImpl<WebAppType<T>>(this, "connection-factory", childNode);
   }
   ...
   {
      List<ConnectionFactoryResourceType<WebAppType<T>>> list = new ArrayList<ConnectionFactoryResourceType<WebAppType<T>>>();
      List<Node> nodeList = childNode.get("connection-factory");
      for(Node node: nodeList)
      {
         ConnectionFactoryResourceType<WebAppType<T>>  type = new ConnectionFactoryResourceTypeImpl<WebAppType<T>>(this, "connection-factory", childNode, node);
         list.add(type);
      }
      return list;
   }
   ...
   public AdministeredObjectType<WebAppType<T>> getOrCreateAdministeredObject()
   {
      ...
      if (nodeList != null &&  nodeList.size() > 0)
      {
         return new AdministeredObjectTypeImpl<WebAppType<T>>(this, "administered-object", childNode, nodeList.get(0));
      }
   ...
   {
      return new AdministeredObjectTypeImpl<WebAppType<T>>(this, "administered-object", childNode);
   }
   ...
   {
      List<AdministeredObjectType<WebAppType<T>>> list = new ArrayList<AdministeredObjectType<WebAppType<T>>>();
      List<Node> nodeList = childNode.get("administered-object");
      for(Node node: nodeList)
      {
         AdministeredObjectType<WebAppType<T>>  type = new AdministeredObjectTypeImpl<WebAppType<T>>(this, "administered-object", childNode, node);
         list.add(type);
      }
      return list;
   }
...
public List<String> getAllModuleName()
   ...
   {
      childNode.getOrCreate("deny-uncovered-http-methods");
      return this;
   }
   ...
   {
      return childNode.getSingle("deny-uncovered-http-methods") != null;
   }
   ...
   {
      childNode.removeChild("deny-uncovered-http-methods");
      return this;
   }
